...
pub fn part_2(input: &str) -> usize {
    ...
    let mut fence_map = vec![vec![b'.'; max_x]; max_y];
        ...
        walk(&Dir::Up, (start_x, start_y - 1), map[start_y - 1][start_x])
    {
        ...
        fence_map[pos_y][pos_x + 1] = b'-';
        fence_map[pos_y][pos_x + 1] = map[pos_y][pos_x + 1];
        (pos_x, pos_y) = (x, y);
        dir = d;
    } else if let Some((d, (x, y))) = walk(
        &Dir::Left,
    ...
    fence_map[pos_y][pos_x] = map[pos_y][pos_x];
    ...
    fence_map[pos_y][pos_x] = match (&start_dir, &dir) {
...
#[cfg(test)]
mod tests {
    use crate::year_2023::{day_10::v2::*, Data};
